Berikut ini langkah2 untuk exprot project ke github melalui gitbush
...
2. Git clone (Alamat github yang ingin kita clone)
3. cd (File repo yang sudah di clone)
4. sudah masuk ke file repo yang di inginkan.
